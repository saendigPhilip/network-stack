...
static constexpr size_t TEST_MAX_KEY_SIZE = 1024;
static constexpr size_t TEST_MAX_VAL_SIZE = 1024;
static constexpr size_t TEST_KV_SIZE = 256;
...
static constexpr uint8_t TOTAL_CLIENTS = 8;
